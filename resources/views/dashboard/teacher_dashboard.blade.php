            ...
            <div class="row mb-4">
                <div class="col-xl-12">
                    ...
                    <div class="carousel-inner">
                        ...
                        <img class="d-block w-100" src="{{ URL::to('assets/images/logoth.jpeg') }}" alt="First slide">
                        </div>
            ...
            <div class="row">
                <div class="col-xl-3" style="max-height: 648px">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 style="height: 60%"><a href="">Báo cáo công khai năm học 2020-2021 của trường Tiểu học A Thanh Hải theo Thông tư 36/2017/TT-BGGĐT ngày 28 tháng 12 năm 2017 của Bộ trưởng Bộ Giáo dục và Đào tạo</a></h4>
                ...
                <div class="col-xl-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 style="height: 60%"><a href="">Trường Tiểu Học A Thanh Hải Trao Quà Tết Cho Những Học Sinh Có Hoàn Cảnh Khó Khăn Nhân Dịp Tết Nhâm Dần 2022</a></h4>
                            <ul class="list-group mb-3 list-group-flush">
                ...
                <div class="col-xl-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 style="height: 60%"><a href="">Trường Tiểu Học A Thanh Hải Tổ Chức Lễ Kỷ Niệm Ngày Nhà Giáo Việt Nam 20/11 Năm Học 2021-2022 Khen Thưởng Các Thầy Cô Có Thành Tích Tốt</a></h4>
                            <ul class="list-group mb-3 list-group-flush">
                ...
                <div class="col-xl-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 style="height: 60%"><a href="">Trường Tiểu Học A Thanh Hải Xây Dựng Trường Chuẩn Quốc Gia Mức Độ II, Kiểm Định Chất Lượng Giáo Dục Xanh- Sạch-Đẹp-An Toàn, Thư Viện Tiên Tiến Năm Học 2021 - 2022
                                </a></h4>
                            <ul class="list-group mb-3 list-group-flush">
